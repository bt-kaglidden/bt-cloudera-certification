...
bc. sudo install-rblje.sh -r /opt/rblje-2.2.2 -s rbl-je-2.2.2.zip -l rlp-license.xml

NB that "/opt/rblje-2.2.2" in the example above is the root directory of the RBL-JE installation.  The _rblje-*.sh_ scripts set the variable RBLJE_ROOT to this value.  If you install RBL-JE somewhere else, edit the _rblje-*.sh_ scripts to match.
